                    ...
                    <div class="w-full h-[62%] relative flex items-center justify-center overflow-hidden bg-[#FAFAFD]">
                        ...
                        <div class="relative z-10 w-[88%] max-w-[310px] h-[86%] flex items-center justify-center pointer-events-none">
                            <svg viewBox="0 0 320 280" class="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M48 70 L53 55 L58 70 L73 75 L58 80 L53 95 L48 80 L33 75 Z" fill="#93C5FD" stroke="#111" stroke-width="1.5"/>
                                
                                <g class="anim-float" style="transform-origin: 225px 45px;">
                                    <ellipse cx="225" cy="45" rx="26" ry="14" fill="#F8B803" stroke="#111" stroke-width="2.5"/>
                                    <ellipse cx="225" cy="42" rx="20" ry="10" fill="#FEE180" stroke="#111" stroke-width="1.5"/>
                                    <path d="M219 39 L231 39 M225 35 L225 49 M221 43 L229 43" stroke="#111" stroke-width="2" stroke-linecap="round"/>
                                </g>

                                <path d="M120 130 V90 C120 60 140 40 170 40 C200 40 220 60 220 90 V130" fill="none" stroke="#111" stroke-width="18" stroke-linecap="round"/>
                                <path d="M120 130 V90 C120 60 140 40 170 40 C200 40 220 60 220 90 V130" fill="none" stroke="#E2E8F0" stroke-width="11" stroke-linecap="round"/>
                                
                                <rect x="100" y="115" width="140" height="120" rx="20" fill="#E2E8F0" stroke="#111" stroke-width="4"/>
                                <rect x="110" y="125" width="120" height="100" rx="14" fill="#CBD5E1"/>

                                <circle cx="170" cy="165" r="14" fill="#0D0E11"/>
                                <polygon points="164,165 176,165 180,195 160,195" fill="#0D0E11"/>

                                <g class="anim-float-rev" style="transform-origin: 140px 175px;">
                                    <circle cx="140" cy="170" r="22" fill="none" stroke="#111" stroke-width="5"/>
                                    <circle cx="140" cy="170" r="22" fill="none" stroke="#F8FAFC" stroke-width="3"/>
                                    
                                    <g transform="rotate(-35 140 170)">
                                        <circle cx="140" cy="145" r="10" fill="#FFFFFF" stroke="#111" stroke-width="2.5"/>
                                        <circle cx="140" cy="145" r="4" fill="#94A3B8"/>
                                        <rect x="137" y="155" width="6" height="45" rx="3" fill="#F1F5F9" stroke="#111" stroke-width="2.5"/>
                                        <rect x="143" y="185" width="8" height="4" fill="#F1F5F9" stroke="#111" stroke-width="2"/>
                                        <rect x="143" y="193" width="6" height="4" fill="#F1F5F9" stroke="#111" stroke-width="2"/>
                                    </g>

                                    <g transform="rotate(30 140 170)">
                                        <circle cx="140" cy="145" r="9" fill="#FEE180" stroke="#111" stroke-width="2.5"/>
                                        <circle cx="140" cy="145" r="3.5" fill="#F59E0B"/>
                                        <rect x="137.5" y="154" width="5" height="40" rx="2.5" fill="#FED766" stroke="#111" stroke-width="2.5"/>
                                        <rect x="132" y="180" width="6" height="4" fill="#FED766" stroke="#111" stroke-width="2"/>
                                        <rect x="132" y="188" width="8" height="4" fill="#FED766" stroke="#111" stroke-width="2"/>
                                    </g>
                                </g>

                                <g class="anim-float" style="transform-origin: 75px 225px;">
                                    <path d="M50 225 C50 215 72 215 95 215 C118 215 140 215 140 225 V235 C140 245 118 245 95 245 C72 245 50 245 50 235 Z" fill="#ECA200" stroke="#111" stroke-width="2.5"/>
                                    <ellipse cx="95" cy="225" rx="45" ry="15" fill="#FED766" stroke="#111" stroke-width="2.5"/>
                                    <ellipse cx="95" cy="223" rx="36" ry="11" fill="#FEF08A" stroke="#111" stroke-width="1.5"/>
                                    <text x="95" y="228" font-family="'Plus Jakarta Sans', sans-serif" font-weight="bold" font-size="14" fill="#B45309" text-anchor="middle">₿</text>
                                </g>

                                <polygon points="268,180 281,195 268,210 255,195" fill="#C084FC" stroke="#111" stroke-width="2"/>
                            </svg>
                        </div>
                    </div>
